...
void House::printInvoice() const
{
	...
	std::cout << std::setw(10) << std::left << getRooms() << std::right << numCoats() << std::setw(23) << HOURLY_RATE << std::setw(12) <<std::right  << "$" << std::right << laborCharges << std::endl;
	std::cout << std::endl << std::setw(31) << std::right << "Product Charges" << std::endl;
	std::cout << std::setw(32) << std::right << "-----------------" << std::endl;
	std::cout << std::setw(10) << std::left << "Room #" << std::right << "Paint Cans" << std::setw(15) << "Unit Cost" << std::setw(18) << "Amount" << std::endl;
	...
	for (int i = 0; i < roomCount(); i++)
	{
		...
		std::cout << std::setw(10) << std::left << i + 1 << std::left << std::setprecision(0) << std::setw(8) << ceil(coats *(pArea / PAINT)) << std::setw(13) << std::right << std::setprecision(2) << PAINT_COST << std::setw(22) << std::right << roomCharge << std::endl;
	...
	std::cout << std::setw(10) << std::left << "Mileage" << std::setw(15) << std::right << "Rate Per Mile" << std::setw(15) << "Total" << std::endl;
	std::cout << std::setw(10) << std::left << getDist() << std::right << MILAGE_COST << std::setw(33) << std::right << "$" << travelCharges << std::endl << std::endl;
...
void House::printToFile() const
{
	...
	outfile << std::setw(10) << std::left << getRooms() << std::right << numCoats() << std::setw(23) << HOURLY_RATE << std::setw(12) << std::right << "$" << std::setw(1) << laborCharges << std::endl;
	outfile << std::endl << std::setw(31) << std::right << "Product Charges" << std::endl;
	outfile << std::setw(32) << std::right << "-----------------" << std::endl;
	outfile << std::setw(10) << std::left << "Room #" << std::right << "Paint Cans" << std::setw(15) << "Unit Cost" << std::setw(18) << "Amount" << std::endl;
	...
	double productCharges = 0;
		for (int i = 0; i < roomCount(); i++)
		{
			...
			outfile << std::setw(10) << std::left << i + 1 << std::left << std::setprecision(0) << std::setw(8) << ceil(coats * (pArea / PAINT)) << std::setw(13) << std::right << std::setprecision(2) << PAINT_COST << std::setw(23) << std::right << roomCharge << std::endl;
	...
	// travel charge calculations
	double travelCharges = dist * MILAGE_COST;
	outfile << std::setw(10) << std::left << "Mileage" << std::setw(15) << std::right << "Rate Per Mile" << std::setw(15) << "Total" << std::endl;
	outfile << std::setw(10) << std::left << getDist() << std::right << MILAGE_COST << std::setw(32) << "$" << travelCharges << std::endl << std::endl;
